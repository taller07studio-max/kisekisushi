...
export default function FooterWaButton({ businessWhatsapp, branches, businessName }: Props) {
  const [open, setOpen] = useState(false)

  const message = `Hola ${businessName}, ¿me pueden dar información?`
  ...
  if (resolution.type === 'direct') {
    return (
      <a href={resolution.url} target="_blank" rel="noopener noreferrer" style={buttonStyle}>
        <WaIcon />
        WhatsApp
      </a>
    )
